...
const AboutSection = () => {
  return (
    <div className='h-[1424px] about-style'>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center md:items-start px-[86px] md:pl-[20px] pt-[50px] md:pt-[115px] gap-[47px] md:gap-[90px] h-[794px] '>
